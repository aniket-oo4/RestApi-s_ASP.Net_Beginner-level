   ...
   public static class DataMapper
    {
        ...
        {
            //LeaveEntity leaveEntity = new LeaveEntity(leaveModel.empId, leaveModel.leaveType, leaveModel.leaveDateFrom, leaveModel.leaveDateTo, leaveModel.remark, leaveModel.status, leaveModel.totalLeaves, leaveModel.leaveId);
            LeaveEntity leaveEntity = new LeaveEntity(leaveModel.leaveId);
